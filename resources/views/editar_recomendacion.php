<?php
	...
	if(isset($_POST['update'])){
		...
		$query = "UPDATE recomendaciones set titulo = '$titulo', descripcion = '$descripcion' WHERE id_recomendacion = $id";
...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Recomendacion</a></li>
		...
		<div class="row">
			<div class="col-md-4 mx-auto">
				<div class="card card-body">
					<form action="editar_recomendacion.php?id=<?php echo $_GET['id']; ?>" method="POST">
						<br>
						<label>Titulo</label>
