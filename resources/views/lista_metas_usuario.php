			...
			<tbody>
				...
				while($row = mysqli_fetch_array($resultado_metas)) { ?>
					<tr>
						...
						<td>
							<a href="lista_acciones_usuario.php?id=<?php echo $row['id_meta']?>" class="btn btn-secondary">
							<i class="fa fa-eye"></i>
							<a href="crear_accion_usuario.php?id=<?php echo $row['id_meta']?>" class="btn btn-secondary">
							<i class="fa fa-file-o"></i></td>
						<td>
							<a href="editar_meta_usuario.php?id=<?php echo $row['id_meta']?>" class="btn btn-warning">
								<i class="fa fa-edit"></i>
							</a>
							<a href="borrar_meta_usuario.php?id=<?php echo $row['id_meta']?>" class="btn btn-danger">
