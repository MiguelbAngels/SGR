		...
		<div class="row">
			<div class="col-md-4 mx-auto">
				<div class="card card-body">
					<form action="editar_reporte_accion.php?id=<?php echo $_GET['id']; ?>" method="POST">
						<br>
						<label>Titulo</label>
					...
					<?php
						...
						<center>
						    <td>
						        <button onclick="location.href='lista_reportes_acciones.php?id=<?php echo $id_area; ?>'">Regresar</button>
						    </td>
					    </center>
				</div>
			</div>
