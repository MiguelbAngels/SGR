			...
			<tbody>
				...
				while($row = mysqli_fetch_array($resultado_acciones)) { ?>
					<tr>
						...
						<td>
							<a href="editar_accion_usuario.php?id=<?php echo $row['id_accion']?>" class="btn btn-warning">
								<i class="fa fa-edit"></i>
							</a>
							<a href="borrar_accion_usuario.php?id=<?php echo $row['id_accion']?>" class="btn btn-danger">
