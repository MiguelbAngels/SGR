		...
		<div class="row">
			<div class="col-md-4 mx-auto">
				<div class="card card-body">
					<form action="editar_accion_usuario.php?id=<?php echo $_GET['id']; ?>" method="POST">
						<br>
						<label>Título</label>
					...
					<center>
					    <td>
					        <button onclick="location.href='lista_acciones_usuario.php?id=<?php echo $id_meta; ?>'">Regresar</button>
					    </td>
				    </center>
				</div>
			</div>
